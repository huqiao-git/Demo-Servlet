...
public class BaseRequestData {
    ...
    public JSON getCOMMON_PARAM() {
        return COMMON_PARAM;
    }

    public void setCOMMON_PARAM(JSON COMMON_PARAM) {
        this.COMMON_PARAM = COMMON_PARAM;
    }

    public String getCOMMON_TICKET() {
        return COMMON_TICKET;
    }

    public void setCOMMON_TICKET(String COMMON_TICKET) {
        this.COMMON_TICKET = COMMON_TICKET;
    }
